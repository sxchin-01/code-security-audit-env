...
_VULN_KEYWORDS: dict[VulnerabilityType, set[str]] = {
    ...
    VulnerabilityType.DEBUG_CONFIGURATION: {
        "debug",
        "configuration",
        "production",
        "verbose",
...
_RELATED_VULN_GROUPS: list[set[VulnerabilityType]] = [
    ...
    {VulnerabilityType.COMMAND_INJECTION, VulnerabilityType.IMPROPER_VALIDATION},
    {VulnerabilityType.IMPROPER_VALIDATION, VulnerabilityType.PATH_TRAVERSAL},
    {VulnerabilityType.BROKEN_AUTHENTICATION, VulnerabilityType.WEAK_HASHING},
    {VulnerabilityType.BROKEN_AUTHENTICATION, VulnerabilityType.RATE_LIMITING},
    {VulnerabilityType.SENSITIVE_DATA_EXPOSURE, VulnerabilityType.API_KEY_LEAKAGE},
    {VulnerabilityType.DEBUG_CONFIGURATION, VulnerabilityType.IMPROPER_VALIDATION},
